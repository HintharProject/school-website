CREATE TABLE IF NOT EXISTS yearbook_batches (
...
CREATE INDEX IF NOT EXISTS idx_yearbook_batches_region ON yearbook_batches (region);
CREATE INDEX IF NOT EXISTS idx_yearbook_batches_active ON yearbook_batches (is_active);
CREATE UNIQUE INDEX IF NOT EXISTS idx_yearbook_batches_region_name ON yearbook_batches (region, name);

INSERT OR IGNORE INTO yearbook_batches (id, name, region, sort_order) VALUES
...
CREATE INDEX IF NOT EXISTS idx_yearbook_batch ON yearbook_alumni (batch_id);
